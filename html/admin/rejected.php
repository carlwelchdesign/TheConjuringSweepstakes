		...
		<?php 
			...
			for ($c=0;$c<count($results);$c++) {
				...
				if($results[$c]['video']!=null){
					...
					echo "			<p class='story'>".substr($results[$c]['videodesc'], 0, 600)."</p> \n";
					...
					echo "			<p class='story'>".substr($results[$c]['photodesc'], 0, 600)."</p> \n";
				}
				
				if($results[$c]['story']!=null){
					
					echo "			<p class='story'>".substr($results[$c]['story'], 0, 600)."</p> \n";
